...
INSERT INTO Pregunta(categoria,contenido,cantEntregada,cantRespondida,porcentajeAcertado,estado) VALUES (1,'de que color era el caballo blanco de san martin?',100,50,50,1),(2,'cuantos balones de oro tiene Messi?',100,50,50,1),(3,'quien fue el director de la pelicula "el resplandor"?',100,50,50,1);
...
INSERT INTO pregunta (categoria, contenido,cantEntregada,cantRespondida,porcentajeAcertado,estado) VALUES (1, '¿Quién fue el primer presidente de los Estados Unidos?',100,50,50,1),(2, '¿En qué año ganó España la Copa del Mundo de fútbol?',100,50,50,1),(3, '¿Quién protagonizó la película "Titanic"?',100,50,50,1);
...
INSERT INTO pregunta (categoria, contenido,cantEntregada,cantRespondida,porcentajeAcertado,estado) VALUES (1, '¿En qué año comenzó la Segunda Guerra Mundial?',100,50,50,1),(2, '¿Cuántos jugadores conforman un equipo de fútbol en el campo?',100,50,50,1),(3, '¿Cuál es el nombre del parque temático de Disney en París?',100,50,50,1);
...
INSERT INTO pregunta (categoria, contenido,cantEntregada,cantRespondida,porcentajeAcertado,estado) VALUES (1, '¿En qué año cayó el Muro de Berlín?',100,50,50,1),(2, '¿Cuál es el deporte más popular en el mundo?',100,50,50,1),(3, '¿Quién escribió la saga de libros "Harry Potter"?',100,50,50,1);
