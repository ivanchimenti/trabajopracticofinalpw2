...
(15, 1, '¿Cuál es el río más largo del mundo?', 50, 50, 60, 1),
(16, 2, '¿Qué planeta es conocido como el planeta rojo?', 50, 50, 60, 1),
(17, 3, '¿Cuántos jugadores hay en un equipo de baloncesto?', 50, 50, 60, 1),
(18, 4, '¿Quién pintó la Mona Lisa?', 50, 50, 60, 1),
(19, 5, '¿Cuál es la capital de Australia?', 50, 50, 60, 1),
(20, 6, '¿Quién escribió "Don Quijote de la Mancha"?', 50, 50, 60, 1),
(21, 1, '¿Cuál es la montaña más alta del mundo?', 50, 50, 60, 1),
(22, 2, '¿Cuántos colores hay en el arcoíris?', 50, 50, 60, 1),
(23, 3, '¿En qué año se celebraron los primeros Juegos Olímpicos modernos?', 50, 50, 60, 1),
(24, 4, '¿Quién dirigió la película "Inception"?', 50, 50, 60, 1),
(25, 5, '¿Cuál es el océano más grande del mundo?', 50, 50, 60, 1),
(26, 6, '¿Quién escribió "La Odisea"?', 50, 50, 60, 1),
(27, 1, '¿En qué continente se encuentra el desierto del Sahara?', 50, 50, 60, 1),
(28, 2, '¿Cuál es el elemento químico más abundante en la Tierra?', 50, 50, 60, 1),
(29, 3, '¿Quién es conocido como el padre del psicoanálisis?', 50, 50, 60, 1),
(30, 4, '¿Cuál es el libro más vendido del mundo?', 50, 50, 60, 1),
(31, 5, '¿Cuál es la capital de Canadá?', 50, 50, 60, 1),
(32, 6, '¿Quién inventó la bombilla?', 50, 50, 60, 1),
(33, 1, '¿En qué país se encuentra la Torre Eiffel?', 50, 50, 60, 1),
(34, 2, '¿Cuál es el animal más grande del mundo?', 50, 50, 60, 1),
(35, 3, '¿Cuántos huesos hay en el cuerpo humano?', 50, 50, 60, 1),
(36, 4, '¿Quién fue el primer hombre en caminar en la luna?', 50, 50, 60, 1),
(37, 5, '¿Cuál es el país más grande del mundo?', 50, 50, 60, 1),
(38, 6, '¿Quién es conocido como el padre de la informática?', 50, 50, 60, 1),
(39, 1, '¿Cuál es el idioma más hablado en el mundo?', 50, 50, 60, 1),
(40, 2, '¿Cuál es el metal más caro del mundo?', 50, 50, 60, 1),
(41, 3, '¿Qué deporte se juega en Wimbledon?', 50, 50, 60, 1),
(42, 4, '¿Quién escribió "1984"?', 50, 50, 60, 1),
(43, 5, '¿Cuál es el lago más grande del mundo?', 50, 50, 60, 1),
(44, 6, '¿Quién inventó el teléfono?', 50, 50, 60, 1),
(45, 1, '¿En qué ciudad se encuentra el Coliseo?', 50, 50, 60, 1),
(46, 2, '¿Cuál es el país con más habitantes del mundo?', 50, 50, 60, 1),
(47, 3, '¿Cuál es la fórmula química del agua?', 50, 50, 60, 1),
(48, 4, '¿Cuál es la moneda oficial de Japón?', 50, 50, 60, 1),
(49, 5, '¿Qué país ganó la Copa Mundial de la FIFA en 2014?', 50, 50, 60, 1),
(50, 6, '¿Quién pintó "La última cena"?', 50, 50, 60, 1),
(51, 1, '¿Cuál es el animal más rápido del mundo?', 50, 50, 60, 1),
(52, 2, '¿Cuál es el planeta más grande del sistema solar?', 50, 50, 60, 1),
(53, 3, '¿Cuántos países hay en el mundo?', 50, 50, 60, 1),
(54, 4, '¿Qué instrumento mide la presión atmosférica?', 50, 50, 60, 1),
(55, 5, '¿Cuál es el país más pequeño del mundo?', 50, 50, 60, 1),
(56, 6, '¿Quién fue el primer hombre en volar solo a través del Atlántico?', 50, 50, 60, 1),
(57, 1, '¿Cuál es la capital de Francia?', 50, 50, 60, 1),
(58, 2, '¿Cuál es el país más poblado de África?', 50, 50, 60, 1),
(59, 3, '¿Cuál es el órgano más grande del cuerpo humano?', 50, 50, 60, 1),
(60, 4, '¿Quién escribió "Hamlet"?', 50, 50, 60, 1),
(61, 5, '¿Cuál es la montaña más alta de América del Norte?', 50, 50, 60, 1),
(62, 6, '¿Quién descubrió América?', 50, 50, 60, 1);
